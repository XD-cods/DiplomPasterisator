...
{\gostFont
	...
	\par \redline Задачей данного дипломного проекта является разработка микросервисной платформы для заказа такси на языке программирования Java.
	...
	\par \redline •  Расчёт полной себестоимости микросервисной платформы заказа такси.
...
{\gostFont
	...
	\par \redline По каталогу функций на основании функций разрабатываемых микросервисных модулей определяется общий объём. Также на основе зависимостей от организационных и технологических условий, был скорректирован объём на основе экспертных оценок.
	...
	\par \redline Перечень и объём функций микросервисных модулей приведён в таблице \thechaptercntr .\thetablecntr .
	...
	{\begin{Center} 
		...
		101 				 & Регистрация и аутентификация         & 450 				    & 520 					          \\ \hline
		\multirow{2}{*}{102} & Управление профилями 				& \multirow{2}{*}{350}  & \multirow{2}{*}{420} 			  \\
		                     & водителей и пассажиров				&                       &                      		      \\ \hline
		103                  & Управление автомобилями (CRUD)		& 280				    & 340							  \\ \hline
		\multirow{2}{*}{301} & Создание и обработка заказов			& \multirow{2}{*}{1100} & \multirow{2}{*}{1410} 			  \\
							 & (ride-service)        			&                       &                      		      \\ \hline
		\multirow{2}{*}{302} & Интеграция картографического 		& \multirow{2}{*}{380}  & \multirow{2}{*}{490}			  \\ 
							 & сервиса и кэширование	        	&                       &                      		      \\ \hline
		\multirow{2}{*}{401} & Интеграция с брокером				& \multirow{2}{*}{600} & \multirow{2}{*}{740}			  \\ 
							 & сообщений и Outbox			        &                       &                      		      \\ \hline
		501                  & API-шлюз: маршрутизация				& 320				    & 380							  \\ \hline
		502                  & Межсервисная авторизация (JWT)		& 290				    & 350							  \\ \hline
		601                  & Сервис рейтинга и оценок				& 240				    & 310							  \\ \hline
		\multirow{2}{*}{701} & Service Discovery, конфигурация,	& \multirow{2}{*}{380} & \multirow{2}{*}{460}			  \\ 
							 & Docker-контейнеризация	        	&                       &                      		      \\ \hline
		\multirow{2}{*}{702} & Мониторинг и тестирование			& \multirow{2}{*}{900} & \multirow{2}{*}{1010}			  \\ 
							 & (метрики, трассировка, логи)	    	&                       &                      		      \\ \hline
		                     & ИТОГО								& 5290				    & 6430							  \\ \hline
	\end{tabular} \end{Center}}
	\botTablespace

	\redline Учитывая информацию, указанную в таблице \thechaptercntr .\thetablecntr, о функциях разрабатываемого программного обеспечения, уточненный объем ПО ($V_{yi}$) составил 6430 строк исходного кода вместо предполагаемого количества строк 5290. \addtocounter{tablecntr}{1}
...
{\gostFont
	...
	\par \redline В данном дипломном проекте для разработки серверной части приложения приобретение какого-либо спецоборудования не предусматривалось. Так как спецоборудование не было приобретено, расходы равны нулю.
...
{\gostFont
	...
	\par \redline Разработанный программный продукт ориентирован на рынок такси-сервисов, где конкуренция достаточно высока. При этом стоимость его разработки остаётся на приемлемом уровне для стартапа или малого предприятия. Стоимость системы, полученная в ходе расчётов, является конкурентной по сравнению с готовыми решениями, представленными на рынке. Основным преимуществом разработанной платформы является возможность гибкого расширения функциональности за счёт микросервисной архитектуры, а также кроссплатформенность за счёт контейнеризации. Таким образом, рассчитанная отпускная цена на серверную часть приложения, разрабатываемую в рамках данного дипломного проекта, составляет 7410,36 белорусских рубля и является конкурентоспособной. При расчете цены учтены отчисления в фонд социальной защиты, а также налоги, необходимые к уплате.

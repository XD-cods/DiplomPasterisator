...
\usepackage[hidelinks, unicode]{hyperref} % hidelinks убирает цветные рамки вокруг ссылок

% Настройка для максимально агрессивного переноса URL
\def\UrlBreaks{\do\/\do\-\do\.\do\&\do\_\do\?\do\=\do\0\do\1\do\2\do\3\do\4\do\5\do\6\do\7\do\8\do\9\do\a\do\b\do\c\do\d\do\e\do\f\do\g\do\h\do\i\do\j\do\k\do\l\do\m\do\n\do\o\do\p\do\q\do\r\do\s\do\t\do\u\do\v\do\w\do\x\do\y\do\z\do\A\do\B\do\C\do\D\do\E\do\F\do\G\do\H\do\I\do\J\do\K\do\L\do\M\do\N\do\O\do\P\do\Q\do\R\do\S\do\T\do\U\do\V\do\W\do\X\do\Y\do\Z}
...
\geometry{bottom=3.5cm} % нижний отступ
...
\uchyph=1 % разрешить перенос слов в верхнем регистре
\hyphenation{API HTTP JSON JWT SQL OAuth REST HTML}
...
\renewcommand{\arraystretch}{1.5} % минимальная высота ячейки 8 мм
...
% настройка шрифтов и языков
    ...
    \setmonofont{Times New Roman} % Заставляем моноширинный шрифт быть как основной
    \urlstyle{same} % шрифт ссылки будет такой же, как у основного текста (Times New Roman)
    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(185,286)(5.5,0.7)
                    ...
                    \put(64.5, 0){\makebox(109,15){\cyrillicfont \englishfont \fontsize{18pt}{0pt}\selectfont ДП.АС64.220047-05 81 00}}

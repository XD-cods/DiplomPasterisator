...
\fontsize{12}{0}
    ...
    \begin{tabular}{p{17.25cm}}
        \hspace{0.6cm} \textsf{- Текст программы должен быть написан на Java}\vspace{0pt} \hline \\
    \end{tabular}
    ...
    \begin{tabular}{p{17.25cm}}
        \hspace{0.3cm} \textsf{??????ассистент кафедры ИИТ Булей Е. В.??????} \hspace{2.3325cm} \textsf{{--} нормоконтроль} \vspace{0pt} \hline \\
    \end{tabular}

...
\begin{document} 
	...
	\par \redline 58 с./ 62 с.,  3 рис.,  9 табл., 10 исп. ист., 1 прил., 5 граф. матер.
	
	\par \redline 

	\par \redline Целью данного дипломного проекта является разработка серверной части приложения заказа такси на основе микросервисной архитектуры. 
	
	\par \redline Приложение разработано с использованием языка Java, фреймворка Spring Boot и среды разработки IntelliJ IDEA. В качестве базы данных используется PostgreSQL, для кэширования - Redis, для асинхронного обмена сообщениями - Apache Kafka, для аутентификации и авторизации - Keycloak. Развертывание системы автоматизировано с помощью Docker и Docker Compose. 
	
	\par \redline Разработанное приложение обеспечивает регистрацию и аутентификацию пользователей, создание заказов на поездку, назначение водителей, обработку геолокации, расчёт стоимости и сопровождение заказа по всем состояниям его жизненного цикла, а также систему рейтинга участников.
	 
	\par \redline Проект включает в себя следующие разделы: введение; анализ предметной области и постановка задачи; проектирование системы; реализация основных модулей; тестирование и развертывание системы; технико-экономическое обоснование; заключение. 

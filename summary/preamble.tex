...
% Рисует рамку
    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(185,285.75)(5, 0)
                    \linethickness{0.5mm}
                    \put(-0.5, 0){\framebox(184.5,284){}} % положение верхней рамки
                    ...
                    \put(64.5, 25){\makebox(120,15){\cyrillicfont \bfseries \englishfont \fontsize{18pt}{0pt}\selectfont ДП.АС64.200047-05 81 00}}
                    ...
                    \put(15.5, 20){\Box{20}{\gostRamkaFont Кужир В.В. }}
                    \put(16.5, 15){\Box{18.25}{\gostRamkaFont Гирель Т.Н. }}
                    \put(17, 5){\Box{18}{\gostRamkaFont  Гирель Т.Н. }}
                    ...
                    \put(64.5, 0){\makebox(70,40){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape  }}
                    \put(64.5, 0){\makebox(70,35){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape Разработка серверной части}}
                    \put(64.5, 0){\makebox(70,25){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape приложения "Такси".}}
                    \put(64.5, 0){\makebox(70,13){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape Пояснительная записка}}
                    \put(134.5, 0){\makebox(49,15){\cyrillicfont \englishfont \fontsize{16pt}{0pt}\selectfont \itshape БрГТУ}}
                    ...
                    \put(164.5, 15){\Box{19}{\gostRamkaFont 57 }}

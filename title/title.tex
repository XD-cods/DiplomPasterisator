...
\fontsize{16pt}{24pt}\selectfont 
  \par РАЗРАБОТКА СЕРВЕРНОЙ ЧАСТИ

  \par ПРИЛОЖЕНИЯ ЗАКАЗА ТАКСИ
...
\fontsize{14pt}{0pt}\selectfont 
  ...
  \begin{tabular}{p{6.5cm} p{4.767cm} p{5.633cm}}
    \raggedleft Руководитель & & Т. Н. Гирель \\ 
  \end{tabular}

  \vspace{14pt}

  \begin{tabular}{p{6.5cm} p{4.767cm} p{5.633cm}}
    \raggedleft Консультант & & Т. Н. Гирель \\
  ...
  \begin{tabular}{p{6.5cm} p{4.767cm} p{5.633cm}}
    \raggedleft Консультант & & А. Б. Поровский \\
  ...
  \begin{tabular}{p{6.5cm} p{4.767cm} p{5.633cm}}
    \raggedleft Выполнил & & В. В. Кужир \\
  \end{tabular}

  \vspace{14pt}

  \begin{tabular}{p{6.5cm} p{4.767cm} p{5.633cm}}
    \raggedleft Нормоконтроль & & Е. В. Швецова \\
  \end{tabular}
